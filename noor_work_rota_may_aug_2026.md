# Noor Rai — Work Rota (May–August 2026)

> Draft shareable rota reconstructed from calendar screenshots. Please verify against the original calendar before using clinically/officially.
...
This file is intended as a human-readable rota source. Possible next steps:

1. Convert this Markdown into a printable HTML/PDF one-pager.
2. Generate an `.ics` calendar file from the table.
3. Build a small web page with colour-coded rota blocks.
4. Add validation against a CSV or manually-entered shift list.
